...
class MayaSelectionMayaPublishPlugin(HookBaseClass):
    ...
    def validate(self, settings, item):
        ...
        return super(MayaSelectionMayaPublishPlugin, self).validate(settings, item)
    ...
    def publish(self, settings, item):
        ...
        super(MayaSelectionMayaPublishPlugin, self).publish(settings, item)

    @property
    def publishTemplate(self):
        return "Selection Maya Publish Template"

    @property
    def propertiesPublishTemplate(self):
        return "selection_maya_publish_template"
    ...
    def settings(self):
        ...
        base_settings = super(MayaSelectionMayaPublishPlugin, self).settings or {}
