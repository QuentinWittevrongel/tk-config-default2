...
class MayaAssetAlembicTECHPublishPlugin(HookBaseClass):

    def accept(self, settings, item):

        self.logger.info("Asset Alembic Technical Publish | accept")
    ...
    def validate(self, settings, item):
        ...
        self.logger.info("Asset Alembic Technical Publish | validate")
        ...
        publihTools.addPublishDatasToPublishItem(self, item, self.propertiesPublishTemplate, addFields={"lod":"TECH"})

        # run the base class validation
        return super(MayaAssetAlembicTECHPublishPlugin, self).validate(settings, item)
    ...
    def publish(self, settings, item):
        ...
        meshes = mayaObject.meshesTechnical
        ...
        super(MayaAssetAlembicTECHPublishPlugin, self).publish(settings, item)

    @property
    def publishTemplate(self):
        return "Asset Alembic Tech Publish Template"

    @property
    def propertiesPublishTemplate(self):
        return "asset_alembic_tech_publish_template"
    ...
    def settings(self):
        ...
        base_settings = super(MayaAssetAlembicTECHPublishPlugin, self).settings or {}
