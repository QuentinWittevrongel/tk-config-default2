...
class HoudiniActions(HookBaseClass):
    ...
    def generate_actions(self, sg_publish_data, actions, ui_area):
        ...
        if("importAlembic_sop" in actions):
            action_instances.append(
                {
                    "name": "importAlembic_sop",
                    "params": None,
                    "caption": "Import Alembic in SOP",
                    "description": "Import the Alembic cache file into the SOP context.",
                }
            )

        if("importMtlx_rop" in actions):
            action_instances.append(
                {
                    "name": "importMtlx_rop",
                    "params": None,
                    "caption": "Import MaterialX in ROP",
                    "description": "Import the MaterialX file into the ROP context.",
                }
            )
    ...
    def execute_action(self, name, params, sg_publish_data):
        ...
        if(name == "importAlembic_sop"):
            self._importAlembicSop(path, sg_publish_data)

        if(name == "importMtlx_rop"):
            self._importMtlxRop(path, sg_publish_data)
    ...
    ##############################################################################################################
    def _importAlembicSop(self, path, sg_publish_data):

        loadTools.importAlembicSop(
